...
const ACTIVITY_ROW_VERBS: Record<string, string> = {
  ...
  "issue.recovery_action_exhausted": "exhausted the recovery action on",
...
const ISSUE_ACTIVITY_LABELS: Record<string, string> = {
  ...
  "issue.recovery_action_exhausted": "Recovery action exhausted its attempts - escalated to the board",
