...
// Fold 2c / barrel-cycle: keep these direct, non-barrel imports. The
// installation-token request schema lives in its own module so `openapi.ts`
// imports schema-only code, not this route handler.
