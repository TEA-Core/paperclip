...
import { dispatchQuiesceRoutes } from "./routes/dispatch-quiesce.js";
...
export async function createApp(
  ...
  api.use(agentGitHubTokenRoutes(db));
  ...
  api.use(dispatchQuiesceRoutes(db));
  api.use(workSessionRoutes(db));
