...
const migrations = [
  "0255_pink_fantastic_four.sql", "0256_conscious_adam_destine.sql",
  "0257_wide_lightspeed.sql", "0258_sleepy_metal_master.sql", "0259_organic_meltdown.sql", "0260_misty_nightshade.sql",
