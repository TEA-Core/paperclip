...
const chatMigrations = [
  ...
  [
    "0275_chat_interaction_wakeup_idempotency",
...
const identityMigrations = [
  "0255_pink_fantastic_four.sql",
  "0256_conscious_adam_destine.sql",
  "0257_wide_lightspeed.sql",
  "0258_sleepy_metal_master.sql",
  "0259_organic_meltdown.sql",
        ...
        try {
          ...
          const cases: Array<{
            ...
            },
            {
              ...
              dedupe: { ...retired, migration: "0260_misty_nightshade" },
              error: oldLine,
            },
